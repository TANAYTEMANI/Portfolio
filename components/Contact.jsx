    ...
    <section id="contact" className="section-padding">
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal delay={0.15}>
          <p className="text-muted dark:text-[#888] text-base font-mono leading-relaxed max-w-xl mb-14">
        ...
        <div className="space-y-12">
                  ...
                  {info.link ? (
                    <a href={info.link} className="card block group">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <p className="text-muted dark:text-[#888] text-xs font-mono uppercase tracking-wider mb-1">
                            {info.label}
                          </p>
          ...
          <ScrollReveal delay={0.25}>
            <motion.a
              ...
              transition={{ duration: 0.2, ease: EASE }}
              className="inline-flex items-center gap-2.5 px-8 py-4 bg-forest dark:bg-mint text-white dark:text-[#0C0C0C] font-mono font-medium text-sm uppercase tracking-wider rounded-full hover:bg-forest-deep dark:hover:bg-[#5BC67B] transition-colors duration-300 hover:shadow-xl hover:shadow-forest/15 dark:hover:shadow-mint/15"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <ScrollReveal delay={0.3}>
          <div className="mt-24 pt-10 border-t border-bone dark:border-[#222] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <p className="text-muted/40 dark:text-[#444] text-xs font-mono">
